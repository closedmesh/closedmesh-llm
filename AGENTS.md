...
4. Tag and push:
   ...
   ```
5. Pushing a `v*` tag triggers `.github/workflows/release.yml`, which builds the release artifacts on Linux CPU, Linux CUDA, Linux AMD ROCm, and macOS and creates the GitHub release automatically.
